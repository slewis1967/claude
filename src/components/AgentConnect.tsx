...
const RUNTIMES: { id: AgentRuntime; label: string; hint: string }[] = [
  { id: "wsl", label: "WSL / Linux", hint: "Runs via `wsl` (use a /mnt/c/… path)" },
...
export function AgentConnect({
  ...
  const [runtime, setRuntime] = useState<AgentRuntime>(current?.runtime ?? "wsl");
    ...
    >
      <div className="mx-auto max-w-3xl px-5 py-4">
        ...
        <p className="mt-2 text-[11px] text-white/35">
          ...
          your message in, its printed output back.
        </p>
